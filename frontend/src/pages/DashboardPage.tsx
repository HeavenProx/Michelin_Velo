...
import {
  Bike, MapPin, TrendingUp, Award, CheckCircle, ArrowRight,
  Droplets, Zap, Target, Mountain, Sun, Calendar,
} from "lucide-react";
import { useApp } from "@/context/AppContext";
import { StarRating } from "@/components/StarRating";
import { StoreSection } from "@/components/StoreSection";
import { RIDER, RECO, PEERS } from "@/data/demo";
      ...
      <div className="px-4 py-5 space-y-5">
        ...
        <div>
          ...
          <div className="space-y-3">
            {PEERS.map((p, i) => {
              const peerInitials = p.name.split(" ").map((n) => n[0]).join("").slice(0, 2).toUpperCase();
              return (
